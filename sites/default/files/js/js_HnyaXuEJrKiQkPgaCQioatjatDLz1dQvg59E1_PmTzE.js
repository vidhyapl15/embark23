...
function makeTimer1() {
	...
	//		var endTime = new Date("29 April 2018 9:56:00 GMT+01:00");	
		var endTime = new Date("29 April 2024 9:56:00 GMT+01:00");			
			...
			if (hours1 < "10") { hours1 = "0" + hours; }
			if (minutes1 < "10") { minutes1 = "0" + minutes; }
			if (seconds1 < "10") { seconds1 = "0" + seconds; }

			$("#days1").html(days1 + "<span>Days</span>");
			$("#hours1").html(hours1 + "<span>Hours</span>");
			$("#minutes1").html(minutes1 + "<span>Minutes</span>");
			$("#seconds1").html(seconds1 + "<span>Seconds</span>");		

	}

	setInterval(function() { makeTimer1(); }, 1000);
  function makeTimer() {  
    var endTime = new Date("07 July 2023 16:15:00 GMT+01:00");    
var endTime = new Date("17 July 2023 10:00:00 GMT+01:00");            
    endTime = (Date.parse(endTime) / 1000);  
    var now = new Date();  
    now = (Date.parse(now) / 1000);  
