...
function makeTimer() {
  ...
  //landing page 1
  function makeTimer1() {  
    //var endTime1 = new Date("07 July 2023 16:15:00 GMT+01:00");    
var endTime1 = new Date("17 July 2023 10:00:00 GMT+01:00");            
    endTime1 = (Date.parse(endTime) / 1000);  
    var now1 = new Date();  
    now1 = (Date.parse(now) / 1000);  
    ...
    if (minutes1 < "10") {alert("hi"); minutes1 = "0" + minutes1; }  
